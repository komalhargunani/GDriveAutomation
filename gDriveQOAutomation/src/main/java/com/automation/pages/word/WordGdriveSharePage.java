...
/** 
 * This class contains all the elements of word GoogleDoc Page test file
...
public class WordGdriveSharePage extends PageElementActions {
...
//		wait = new WebDriverWait(driver,30);
	...
	/**
     * This method is used to verify the open word
     * page title/fileName
     * 
