...
define([
  ...
  var api_ = MixinUtils.mergeMixin(DecoratorBase, {
    ...
    supports_: ['paraStyleId'],

    observers: [
      'paraStyleIdChanged_(model.ppr.paraStyleId)'
    ],

    get paraStyleId() {
      return (this.model &&
              this.model.ppr &&
              this.model.ppr.paraStyleId);
    },

    set paraStyleId(value) {
      this.setInModel_('ppr.paraStyleId', value);
    },

    paraStyleIdChanged_: function(current) {
      var officeStyles = document.getElementById('qowtOfficeStyles');
      if (officeStyles) {
        if (this.previousParaStyleId_) {
          var previousCss = officeStyles.getCssClassName(
              this.previousParaStyleId_);
      ...
      this.previousParaStyleId_ = current;
    },
    ...
    computedDecorations_: {
      paraStyleId: function(/* computedStyles */) {
        return this.model.ppr && this.model.ppr.paraStyleId;
      }
    }
