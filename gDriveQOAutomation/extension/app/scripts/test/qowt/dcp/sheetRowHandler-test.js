define([
  ...
  describe('sheet row DCP Handler', function() {
    ...
    it('should apply background colors for rows', function() {
      ...
      var rowDCP = RowFixture.sheetRowElement(3, undefined, formatting);

      var v = {
        el: rowDCP
      };
      SheetRowHandler.visit(v);
    ...
    it('should store borders formatting information for rows', function() {
      ...
      var rowDCP = RowFixture.sheetRowElement(0, undefined, formatting);
      var v = {
        el: rowDCP,
        node: parentNode_
      };
    ...
    it('should cache the specific row height when the row DCP has one ' +
      ...
      var rowFormatting = {};
      var rowDCP = RowFixture.sheetRowElement(rowIndex, specificRowHeight,
        rowFormatting);
      var v = {
        el: rowDCP
      };
