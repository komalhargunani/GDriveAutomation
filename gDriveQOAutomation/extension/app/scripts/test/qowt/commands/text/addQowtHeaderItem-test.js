define([
  ...
  describe('addQowtHeaderItem command creation', function() {
    ...
    var textCommand = AddQowtHeaderItemCmd.create(context);
    ...
    it('should check for missing crucial contextual information', function() {
      ...
      CommandTestUtils.expectInvalidConstructionContextsToThrow(
          AddQowtHeaderItemCmd, invalidContexts);
    });
  });
});
