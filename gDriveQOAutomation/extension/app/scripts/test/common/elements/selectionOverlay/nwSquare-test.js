define([
  ...
  xdescribe('Test nwSquare.js', function() {

    var selectionOverlay_, nwSquare_, elmPos_, sandbox_;
    ...
    beforeEach(function() {
      ...
      nwSquare_ = new QowtNWSquare(selectionOverlay_);
      selectionOverlay_.appendChild(nwSquare_);
    ...
    afterEach(function() {
      selectionOverlay_.removeChild(nwSquare_);
      selectionOverlay_ = undefined;
      sandbox_.restore();
    });


    it('should lie on the top left corner of the overlay', function() {
      ...
      assert.strictEqual(expectedLeftPos, nwSquare_.customLeftPos);
      assert.strictEqual(expectedTopPos, nwSquare_.customTopPos);
    });
  });
