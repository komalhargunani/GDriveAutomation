define([
  ...
  xdescribe('Test nSquare.js', function() {

    var selectionOverlay_, nSquare_, elmPos_, sandbox_;
    ...
    beforeEach(function() {
      ...
      nSquare_ = new QowtNSquare(selectionOverlay_);
      selectionOverlay_.appendChild(nSquare_);
    ...
    afterEach(function() {
      selectionOverlay_.removeChild(nSquare_);
      selectionOverlay_ = undefined;
      sandbox_.restore();
    });


    it('should lie on the middle of top edge of the overlay', function() {
      ...
      assert.strictEqual(expectedLeftPos, nSquare_.customLeftPos);
      assert.strictEqual(expectedTopPos, nSquare_.customTopPos);
    });
  });
