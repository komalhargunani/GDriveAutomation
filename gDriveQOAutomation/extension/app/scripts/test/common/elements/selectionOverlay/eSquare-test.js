define([
  ...
  xdescribe('Test eSquare.js', function() {

    var selectionOverlay_, eSquare_, elmPos_, sandbox_;
    ...
    beforeEach(function() {
      ...
      eSquare_ = new QowtESquare(selectionOverlay_);
      selectionOverlay_.appendChild(eSquare_);
    ...
    afterEach(function() {
      selectionOverlay_.removeChild(eSquare_);
      selectionOverlay_ = undefined;
      sandbox_.restore();
    });


    it('should lie on the middle of right edge of the overlay', function() {
      ...
      assert.strictEqual(expectedLeftPos, eSquare_.customLeftPos);
      assert.strictEqual(expectedTopPos, eSquare_.customTopPos);
    });
  });
