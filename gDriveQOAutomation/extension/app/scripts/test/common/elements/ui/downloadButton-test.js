define([], function() {
  ...
  describe('Tool tip test for download button', function() {
    var button, toolTip;

    beforeEach(function() {
      this.stampOutTempl('qowt-download-button-test-template');
      button = this.getTestDiv().querySelector('qowt-downloadbutton');
