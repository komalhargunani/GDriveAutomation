define([], function() {
  ...
  describe('Tool tip test for share button', function() {
    var button, toolTip;

    beforeEach(function() {
      this.stampOutTempl('qowt-share-button-test-template');
      button = this.getTestDiv().querySelector('qowt-sharebutton');
