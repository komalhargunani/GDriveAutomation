...
(function(global) {
  ...
  function MutationSummary(opts) {
    ...
    var observer = new MutationObserver(function(mutations) {
      ...
      // During the deletion of content from the table, window selection is
      // not persistent and cursor caret gets misplaced in the wrong position.
      // To fix this issue, we need to perform any operation related to the
      // window selection.
