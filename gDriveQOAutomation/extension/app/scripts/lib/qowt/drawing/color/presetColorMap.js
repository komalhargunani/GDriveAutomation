/**
 * @fileoverview preset color map; ensures color names are matches to preset
 * color map and returns appropriate hex value.
 *
...
define([], function() {
  ...
  var _api = {
    /**
     * Returns an array which has RGB equivalent values of color provided
     * @param colorName {String} name of color
     */
    getRgbEquivalentPresetColor: function(colorName) {
      return _map[colorName];
    }
  };

  /**
   * Following map has created as per ECMA 376 specification, section
   * 20.1.2.3.22 (preset color). It maps color name with its equivalent RGB
   * values in array.
   */
  var _map = {
