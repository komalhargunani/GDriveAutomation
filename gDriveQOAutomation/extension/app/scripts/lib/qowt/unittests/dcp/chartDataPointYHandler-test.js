...
define([
  ...
  describe('chart data point Y DCP Handler', function() {
    ...
    it('should ignore the DCP if its element-type is not dpY', function() {
      var v = {
        el: {
          etp: 'blah'
        }
    ...
    it('should handle an undefined DcpModel.dcpHandlingChart', function() {
      ...
      var dataPointYDCP = FIXTURES.dataPointY();
      var result = handler.visit({el: dataPointYDCP});
    ...
    it('should successfully cache a data point in a series in ChartsModel',
        function() {
          var yVal = 37;
          var dataPointYDCP = FIXTURES.dataPointY(yVal);
          var result = handler.visit({el: dataPointYDCP});
    ...
    it('should successfully cache multiple data points in a series in ' +
        'ChartsModel', function() {
          var yVal1 = 13;
          var dataPointYDCP = FIXTURES.dataPointY(yVal1);
          var result = handler.visit({el: dataPointYDCP});
          expect(result).toBeUndefined();
          var yVal2 = 82;
          dataPointYDCP = FIXTURES.dataPointY(yVal2);
          result = handler.visit({el: dataPointYDCP});
          expect(result).toBeUndefined();
          var yVal3 = 75;
          dataPointYDCP = FIXTURES.dataPointY(yVal3);
          result = handler.visit({el: dataPointYDCP});
          expect(result).toBeUndefined();
